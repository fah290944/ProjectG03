...
import { DoctorInterface, MedActivityInterface, ScheduleInterface, LocationInterface } from "../../models/ISchedule";
      ...
      <Container maxWidth="md">
        ...
        <Paper>
          ...
          <Grid container spacing={3} sx={{ padding: 2 }}>
            ...
            <Grid item xs={12}>
              <Button component={RouterLink} to="/ScheduleShow" variant="contained">
                <Typography
                  color="secondary"
                  component="div"
                  sx={{ flexGrow: 1 }}
